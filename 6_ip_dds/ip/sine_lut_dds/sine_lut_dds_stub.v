...
// Command     : write_verilog -force -mode synth_stub -rename_top sine_lut_dds -prefix
//               sine_lut_dds_ dds_compiler_0_stub.v
...
module sine_lut_dds(aclk, s_axis_phase_tvalid, 
